...
// Ref to catalog schema - https://github.com/meshplay/schemas/blob/master/schemas/constructs/v1alpha1/catalog_data.json
func GetCatalogClasses() []ContentClassObj {
	return []ContentClassObj{
		{
			Class:       Official,
			Description: "Content produced and fully supported by Meshplay maintainers. This represents the highest level of support and is considered the most reliable.",
		},
		{
			Class:       Verified,
			Description: "Content produced by partners and verified by Meshplay maintainers. While not directly maintained by Meshplay, it has undergone a verification process to ensure quality and compatibility.",
		},
		{
			Class:       Community,
			Description: "Content produced and shared by Meshplay users. This includes a wide range of content, such as performance profiles, test results, filters, patterns, and applications. Community content may have varying levels of support and reliability.",
		},
	}
}
